/*!
 * BeefUp 1.4.11 - A jQuery Accordion Plugin
...
(function(r) {
    ...
    l.methods = {
        ...
        _addSelfCloseEvent: function(n, i) {
            if (!i.selfClose) {
                return
            }
        ...
        _addHashchangeEvent: function(t, n) {
            if (!n.hash) {
                return
            }
            var e = function() {
        ...
        _initAccessibility: function(e, t) {
