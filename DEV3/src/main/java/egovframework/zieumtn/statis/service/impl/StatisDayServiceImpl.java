...
public class StatisDayServiceImpl extends EgovAbstractServiceImpl implements StatisDayService {

	private static final Logger LOGGER = LoggerFactory.getLogger(StatisDayServiceImpl.class);

	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "statisDayDAO")
	private StatisDayDAO statisDayDAO;
	// TODO mybatis 사용
	...
	@Override
	public List<?> selectStatisDayList(StatisDayVO vo) throws Exception {
		List<?> rs = statisDayDAO.selectStatisDayList(vo);
		return rs;
	}
