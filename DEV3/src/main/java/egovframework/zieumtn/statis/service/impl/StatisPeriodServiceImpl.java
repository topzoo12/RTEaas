...
@Service("statisPeriodService")
public class StatisPeriodServiceImpl extends EgovAbstractServiceImpl implements StatisPeriodService {

	private static final Logger LOGGER = LoggerFactory.getLogger(StatisPeriodServiceImpl.class);

	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "statisPeriodDAO")
	private StatisPeriodDAO statisPeriodDAO;
	// TODO mybatis 사용
	...
	@Override
	public List<?> selectStatisPeriodList(StatisPeriodVO vo) throws Exception {
		List<?> rs = statisPeriodDAO.selectStatisPeriodList(vo);
		return rs;
	}
