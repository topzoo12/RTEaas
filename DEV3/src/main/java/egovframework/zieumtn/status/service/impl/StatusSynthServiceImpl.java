...
import egovframework.zieumtn.status.dao.StatusSynthDAO;
...
@Service("statusSynthService")
public class StatusSynthServiceImpl extends EgovAbstractServiceImpl implements StatusSynthService {

	private static final Logger LOGGER = LoggerFactory.getLogger(StatusSynthServiceImpl.class);

	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "statusSynthDAO")
	private StatusSynthDAO statusSynthDAO;
	// TODO mybatis 사용
	...
	@Override
	public List<?> selectStatusSynthList(StatusSynthVO vo) throws Exception {
		List<?> rs = statusSynthDAO.selectStatusSynthList(vo);
		return rs;
	}
