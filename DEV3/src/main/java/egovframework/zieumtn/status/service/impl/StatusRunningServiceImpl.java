...
import egovframework.zieumtn.status.dao.StatusRunningDAO;
...
@Service("statusRunningService")
public class StatusRunningServiceImpl extends EgovAbstractServiceImpl implements StatusRunningService {

	private static final Logger LOGGER = LoggerFactory.getLogger(StatusRunningServiceImpl.class);

	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "statusRunningDAO")
	private StatusRunningDAO statusRunningDAO;
	// TODO mybatis 사용
	//  @Resource(name="sampleMapper")
	//	private SampleMapper sampleDAO;

	@Override
	public List<?> selectStatusRunningList(StatusRunningVO vo) throws Exception {
		List<?> rs = statusRunningDAO.selectStatusRunningList(vo);
		return rs;
	}


	@Override
	public List<?> selectStatusRunningDetailList(StatusRunningVO vo) throws Exception {
		List<?> rs = statusRunningDAO.selectStatusRunningDetailList(vo);
		return rs;
	}
