...
import egovframework.zieumtn.status.dao.StatusCarDAO;
...
@Service("statusCarService")
public class StatusCarServiceImpl extends EgovAbstractServiceImpl implements StatusCarService {

	private static final Logger LOGGER = LoggerFactory.getLogger(StatusCarServiceImpl.class);

	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "statusCarDAO")
	private StatusCarDAO statusCarDAO;
	// TODO mybatis 사용
	...
	public List<?> selectStatusCarList(StatusCarVO vo) throws Exception {
		List<?> rs = statusCarDAO.selectStatusCarList(vo);
		return rs;
	}
	...
	public List<?> selectStatusCarDetailList(StatusCarVO vo) throws Exception {
		List<?> rs = statusCarDAO.selectStatusCarDetailList(vo);
		return rs;
	}
	...
	public int insertCar(StatusCarVO paramVO) throws Exception {
		int rs = statusCarDAO.insertCar(paramVO);
		return rs;
	}
	...
	public int updateCar(StatusCarVO paramVO) throws Exception {
		int rs = statusCarDAO.updateCar(paramVO);
		return rs;
	}
	...
	public int deleteCar(StatusCarVO paramVO) throws Exception {
		int rs = statusCarDAO.deleteCar(paramVO);
		return rs;
	}
