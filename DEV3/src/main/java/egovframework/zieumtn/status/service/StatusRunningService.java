 ...
 */
public interface StatusRunningService {

	List<?> selectStatusRunningList(StatusRunningVO vo) throws Exception;

	List<?> selectStatusRunningDetailList(StatusRunningVO vo) throws Exception;
