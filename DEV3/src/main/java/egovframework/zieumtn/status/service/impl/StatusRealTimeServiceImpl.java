...
@Service("statusRealTimeService")
public class StatusRealTimeServiceImpl extends EgovAbstractServiceImpl implements StatusRealTimeService {

	private static final Logger LOGGER = LoggerFactory.getLogger(StatusRealTimeServiceImpl.class);

	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "statusRealTimeDAO")
	private StatusRealTimeDAO statusRealTimeDAO;
	// TODO mybatis 사용
	...
	@Override
	public List<?> selectStatusRealTimeList(StatusRealTimeVO vo) throws Exception {
		List<?> rs = statusRealTimeDAO.selectStatusRealTimeList(vo);
		return rs;
	}


	@Override
	public List<?> selectStatusRealTimeChartList(StatusRealTimeChartVO vo) throws Exception {
		List<?> rs = statusRealTimeDAO.selectStatusRealTimeChartList(vo);
		return rs;
	}
