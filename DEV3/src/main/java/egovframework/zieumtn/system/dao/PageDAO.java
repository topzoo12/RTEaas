...
@Repository("pageDAO")
public class PageDAO extends EgovAbstractDAO {

	public List<?> selectPageList(PageVO vo) throws Exception {
		return list("pageDAO.selectPageList", vo);
	}
