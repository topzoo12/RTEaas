 ...
 */
public interface AuthgrpMenuService {

	List<?> selectAuthgrpMenuList(AuthgrpMenuVO vo) throws Exception;


	int updateAuthgrpMenu(AuthgrpMenuVO paramVO) throws Exception;

	void copyAuthgrpMenu(ServiceVO paramVO) throws Exception;

	void confirmcopyAuthgrpMenu(ServiceVO paramVO) throws Exception;
