...
import egovframework.zieumtn.system.dao.UsageDataDAO;
...
public class UsageDataServiceImpl extends EgovAbstractServiceImpl implements UsageDataService {

	private static final Logger LOGGER = LoggerFactory.getLogger(UsageDataServiceImpl.class);

	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "usageDataDAO")
	...
	@Override
	public List<?> selectUsageDataList(UsageSearchVO vo) throws Exception {
		List<?> rs = usageDataDAO.selectUsageDataList(vo);
		return rs;
	}
