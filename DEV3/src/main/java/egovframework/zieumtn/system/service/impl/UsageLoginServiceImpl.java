...
import egovframework.zieumtn.system.dao.UsageLoginDAO;
...
@Service("usageLoginService")
public class UsageLoginServiceImpl extends EgovAbstractServiceImpl implements UsageLoginService {

	private static final Logger LOGGER = LoggerFactory.getLogger(UsageLoginServiceImpl.class);

	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "usageLoginDAO")
	private UsageLoginDAO usageLoginDAO;
	// TODO mybatis 사용
	...
	@Override
	public List<?> selectUsageLoginList(UsageSearchVO vo) throws Exception {
		List<?> rs = usageLoginDAO.selectUsageLoginList(vo);
		return rs;
	}
