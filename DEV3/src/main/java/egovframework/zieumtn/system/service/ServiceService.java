...
public interface ServiceService {
	...
	List<?> selectServiceList(ServiceVO vo) throws Exception;

	List<?> selectDistrictList(ServiceVO vo) throws Exception;

	List<?> selectStationList(ServiceVO vo) throws Exception;

	ServiceVO  selectServiceManagerMail(ServiceVO vo) throws Exception;
	...
	int deleteService(ServiceVO paramVO) throws Exception;
}
