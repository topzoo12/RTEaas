...
import egovframework.zieumtn.system.dao.AuthgrpUserDAO;
...
@Service("authgrpUserService")
public class AuthgrpUserServiceImpl extends EgovAbstractServiceImpl implements AuthgrpUserService {

	private static final Logger LOGGER = LoggerFactory.getLogger(AuthgrpUserServiceImpl.class);

	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "authgrpUserDAO")
	private AuthgrpUserDAO authgrpUserDAO;
	// TODO mybatis 사용
	...
	public List<?> selectAuthgrpUserList(AuthgrpUserVO vo) throws Exception {
		List<?> rs = authgrpUserDAO.selectAuthgrpUserList(vo);
		return rs;
	}
