 ...
 */
public class UsageUserVO extends CommonDefaultVO {
	...
	public String getCnctDtm() {
		return cnctDtm;
	}
	public void setCnctDtm(String cnctDtm) {
		this.cnctDtm = cnctDtm;
	}
